      ...
      <div class="hero-content grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="text-content space-y-6">
          <div class="greeting text-accent-500 font-medium text-lg mb-2">
            <span class="inline-block animate-bounce-in">Hello, I'm</span>
          </div>
          
          <h1 class="main-title text-6xl lg:text-7xl font-serif font-bold leading-tight">
            <span class="block animate-slide-up text-gray-900 dark:text-white" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.1);">Irfandy</span>
            <span class="block animate-slide-up text-gray-900 dark:text-white" style="animation-delay: 0.2s; text-shadow: 2px 2px 4px rgba(0,0,0,0.1);">Aziz</span>
          </h1>
          
          <div class="role-container">
            <h2 class="role text-2xl lg:text-3xl font-medium text-primary-600 dark:text-primary-400 mb-4 animate-slide-up" style="animation-delay: 0.4s">
              Fullstack Developer
            </h2>
            <div class="typing-animation text-xl text-neutral-700 dark:text-neutral-300 animate-slide-up" style="animation-delay: 0.6s">
              <span class="typing-text">Crafting elegant, performant web applications</span>
            </div>
          </div>
          
          <p class="description text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl leading-relaxed animate-slide-up" style="animation-delay: 0.8s">
          ...
          <div class="cta-buttons flex flex-wrap gap-4 animate-slide-up" style="animation-delay: 1s">
          ...
          <!-- Social Links -->
          <div class="social-links flex gap-4 animate-slide-up" style="animation-delay: 1.2s">
            <a href="https://github.com/irfandy" target="_blank" rel="noopener" class="social-link group">
            ...
            <a href="https://wa.me/6281234567890" target="_blank" rel="noopener" class="social-link group">
              <svg class="w-6 h-6 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
