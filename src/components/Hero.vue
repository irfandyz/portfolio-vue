      ...
      <div class="hero-content grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="image-container relative" style="opacity: 1; visibility: visible;">
          <div class="image-wrapper relative">
            ...
            />
            <div class="absolute -top-4 -right-4 w-24 h-24 bg-accent-400 rounded-full opacity-20"></div>
            <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-primary-400 rounded-full opacity-30"></div>
          </div>
        </div>
      </div>
    </div>
