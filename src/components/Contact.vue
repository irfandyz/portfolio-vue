    ...
    <div class="container mx-auto px-4">
      <div class="max-w-6xl mx-auto">
          ...
          <div class="space-y-8">
            <div class="card">
              ...
              <p class="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-8">
                ...
                project in mind or just want to chat about web development, feel free to reach out!
              </p>
              ...
              <div class="space-y-6">
                ...
                <div class="contact-item group">
                  ...
                  <div class="contact-details">
                    ...
                    <a href="https://www.linkedin.com/in/irfandy-aziz" target="_blank" rel="noopener" class="contact-link">
                      linkedin.com/in/irfandy-aziz
                    </a>
                    <p class="contact-description">Professional networking and career opportunities</p>
                  </div>
                </div>
            ...
            <!-- Availability Status -->
            <div class="card bg-gradient-to-r from-green-500 to-emerald-500 text-white">
              <div class="flex items-center mb-4">
                <div class="w-3 h-3 bg-green-300 rounded-full mr-3 animate-pulse"></div>
                <h3 class="text-xl font-serif font-semibold">Currently Available</h3>
              </div>
              <p class="text-green-100">
                I'm currently available for new projects and collaborations. 
                Let's discuss your ideas and see how I can help!
              </p>
            </div>
          </div>
        ...
        <div class="text-center mt-16">
          <h3 class="text-2xl font-serif font-semibold text-neutral-900 dark:text-neutral-50 mb-8">
            Follow Me
          </h3>
          <div class="flex justify-center gap-6">
            ...
            <a
              href="https://www.linkedin.com/in/irfandy-aziz"
              target="_blank"
              rel="noopener"
              class="social-link group"
            >
...
.contact-item {
  @apply flex items-start space-x-4 p-4 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-colors;
}

.contact-icon {
  @apply w-12 h-12 bg-primary-100 dark:bg-primary-900 rounded-lg flex items-center justify-center text-primary-600 dark:text-primary-400 flex-shrink-0;
}
...
.contact-title {
  @apply text-lg font-semibold text-neutral-900 dark:text-neutral-50 mb-1;
}

.contact-link {
  @apply text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium transition-colors;
}
